...
let getCityWeather = function(city) {
    let apiUrl = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=dbf77319a18aafca7d3116d509839a35";
    fetch(apiUrl) 
...
let displayWeather = function(weatherData) {
    ...
    fetch("https://api.openweathermap.org/data/2.5/uvi?lat=" + weatherData.coord.lat + "&lon="+ weatherData.coord.lon + "&appid=dbf77319a18aafca7d3116d509839a35")
        .then(function(response) {
            response.json().then(function(data) {
    ...
    fetch("https://api.openweathermap.org/data/2.5/forecast?q=" + weatherData.name + "&appid=dbf77319a18aafca7d3116d509839a35")
        .then(function(response) {
            response.json().then(function(data) {
                $("#five-day").empty();
